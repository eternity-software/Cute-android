...
public class GraphicOverlay extends View {
    ...
    public void setmWidthScaleFactor(float mWidthScaleFactor) {
        this.mWidthScaleFactor = mWidthScaleFactor;
    }

    public void setmHeightScaleFactor(float mHeightScaleFactor) {
    ...
    public void setmFrontFacing(boolean mFrontFacing) {
        this.mFrontFacing = mFrontFacing;
    }
